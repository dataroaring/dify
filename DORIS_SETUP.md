...
2. **Set Vector Store to Doris**
   ...
   DORIS_STREAMLOAD_PORT=8080      # Doris HTTP port (SelectDB Cloud uses 8080, open-source default is 8030)

   # Connection pool configuration (optional)
   DORIS_MIN_CONNECTION=1          # Minimum connections (default 1)
   ...
   DORIS_TEXT_SEARCH_ANALYZER=english  # Text analyzer: english, chinese, standard (default english)
   ```
...
### 2. Test StreamLoad Endpoint

Check if Doris HTTP endpoint is accessible:
```bash
curl http://your-doris-host:8030/api/dify/_stream_load
```
...
- [Doris Vector Search Documentation](https://doris.apache.org/docs/4.x/ai/vector-search/overview)
- [Doris Text Search Documentation](https://doris.apache.org/docs/4.x/ai/text-search/overview)
